...
.controller('userHome', ['$scope', '$q', '$timeout', 'PageFunc', 'Storage', 'User', 'Consumption', 'Socket', '$ionicHistory', function ($scope, $q, $timeout, PageFunc, Storage, User, Consumption, Socket, $ionicHistory) {
    ...
    $scope.actions = {
        ...
        /*bcp: function() {
            barcodeXs.routes('ONLP|555feb39f369caf028fef239', 'user', '');
        }*/
    };
...
.controller('userApply', ['$scope', '$state', 'User', 'Consumption', 'PageFunc', '$ionicHistory', '$ionicSlideBoxDelegate', '$ionicLoading', 'CONFIG', function ($scope, $state, User, Consumption, PageFunc, $ionicHistory, $ionicSlideBoxDelegate, $ionicLoading, CONFIG) {
    $scope.config = {
...
.controller('userConsList', ['$scope', '$q', '$ionicPopover', 'Consumption', 'PageFunc', '$cordovaBarcodeScanner', '$ionicHistory', 'Storage', '$stateParams', '$ionicHistory', '$ionicListDelegate', function ($scope, $q, $ionicPopover, Consumption, PageFunc, $cordovaBarcodeScanner, $ionicHistory, Storage, $stateParams, $ionicHistory, $ionicListDelegate) {
    var batch = null;
    var lastTime = null; 
    var consList = [];
    var init = function () {
    ...
    $scope.actions = {
        ...
        revokeItem: function (item, $index, event) {
...
.controller('userAround', ['$scope', '$timeout', function ($scope, $timeout) {
    $scope.mapOptions = {
        scaleCtrl: false,
        zoom: 12,
    };
