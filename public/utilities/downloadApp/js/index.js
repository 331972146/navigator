...
$.fn.appconect = function(options) {    
  ...
  var BigUrl;
   ...
   if(oAction==1 || oAction==7){
      BigUrl="http://ddsc.location?action="+oAction+"&title="+oTitle+"&content="+oContent+"&url="+oUrl+"&channel="+oChannel;
    }else if(oAction==5){
     ...
     BigUrl="http://ddsc.location?action="+oAction+"$content="+oContent;
      ...
      BigUrl="http://ddsc.location?action="+oAction+"&channel="+oChannel;
    }
    ...
    var browser = {
      ...
      var content = "&title="+oTitle+"&content="+oContent+"&url="+oUrl+"&channel="+oChannel;
     ...
     // alert($(document).height())
      ...
      $(".black_bg,.wrp_jump_tip").on("click",function  () {
        ...
        if (browser.versions.iPhone|| browser.versions.iPad ) {
         ...
         $(".download_btn").attr("href","http://17f.xy.net/app/yyb.apk")
        }
    }  
};
